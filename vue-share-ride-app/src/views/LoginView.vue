<template>
  <div class="pt-16">
    <h1 class="text-3xl font-semibold mb-4">Broj telefona</h1>
...
const handleLogin = () => {
  axios
    .post("http://127.0.0.1:8000/api/login", formatedCredentials())
    .then((res) => {
...
const handleVerification = () => {
  axios
    .post("http://127.0.0.1:8000/api/login/verify", formatedCredentials())
    .then((response) => {
