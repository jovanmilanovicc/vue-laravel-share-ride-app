    ...
    <div v-else>
      <div class="overflow-hidden shadow sm:rounded-md max-w-sm mx-auto text-left">
        <div class="bg-white px-4 py-5 sm:p-6">
          ...
          <div class="mt-2">
            <p class="text-xl">
              Idete do <strong>{{ trip.destination_name }}</strong>
            </p>
          </div>
        </div>
...
const title = ref("Čeka se zahtjev za vožnju...");
const gMap = ref(null);
...
const handleDeclineTrip = () => {
  trip.reset();
  title.value = "Čeka se zahtjev za vožnju...";
};
